...
# Funções legadas de scraping (get_data_acoes, get_data_fiis, etc) removidas em favor dos pipelines modulares (yfinance).

# get_candle_chart movido para modules.data_fetcher
...
# KNOWN_ETFS, RISKY_TICKERS e Funções de Risco movidas para modules
...
# ------------------------------------------------------------------------------
# Pipelines movidos para modules.data_fetcher
...
if current_tab == "AÇÕES":
    ...
    selected_m = st.multiselect(
        ...
        key="ms_market_sel",
        help="Selecione um ou mais mercados para visualizar."
    )
